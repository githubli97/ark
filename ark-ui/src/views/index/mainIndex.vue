        ...
        <div class="card bbxx">
          ...
          <div class="table">
            ...
            <p><span class="tit">获取渠道</span>
                <span class="gitbox">
                  <a target="_blank" href="#"><el-button type="primary" icon="el-icon-download" size="small">github</el-button></a>
                  <a target="_blank" href="#"><el-button type="primary" icon="el-icon-download" size="small">码云</el-button></a>
                </span>
            </p>
          </div>
        </div>
