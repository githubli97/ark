...
public class AccountFactory {
    ...
    public static PhoneAccount phoneAccountRegister(TenantId tenantId, ChinaPhone chinaPhone, Role role, DepartmentId departmentId) {
        PhoneAccount phoneAccount = new PhoneAccount(Lists.newArrayList(tenantId), chinaPhone, departmentId);
